...
function create_task_giver(work_cfg, quest_giver_scenario)
	...
	quest_giver = CreatePed(1, work_cfg.QuestGiver.NPCHash, work_cfg.QuestGiver.NPCXAxis, work_cfg.QuestGiver.NPCYAxis, work_cfg.QuestGiver.NPCZAxis, 60, false, true)
...
-- 	RemoveBlip(current_work_blip)
--     cb(job_config.WorkPoints[math.random(#job_config.WorkPoints)], AddBlipForCoord(random_work_position.x, random_work_position.y, 30.0)
-- end
...
-- 	getOutOfUniform()
-- 	reward = math.floor(progression_step / 4)
